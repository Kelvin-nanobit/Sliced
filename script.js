...
lgaSelect.addEventListener("change", function() {
  ...
  const wards = wardData[selectedState]?.[selectedLGA] || [];
...
fetch("https://temikeezy.github.io/nigeria-geojson-data/data/lgas-with-wards.json")
  .then(function(response) {
    return response.json();
  })
  .then(function(data) {
    wardData = data;
    console.log("Ward data loaded");
  });

  const ageRange = document.querySelector('input[type="range"]');
...
ageRange.addEventListener("input", function() {
  ...
  ageRange.style.background = `linear-gradient(to right, #2E7D78 ${percent}%, #e0e0e0 ${percent}%)`;
});
...
maleOption.addEventListener("click", function() {
  document.querySelector(".gender-icon.male").style.background = "#2E7D78";
  document.querySelector(".gender-icon.female").style.background = "#ccc";
});

femaleOption.addEventListener("click", function() {
  document.querySelector(".gender-icon.female").style.background = "#2E7D78";
  document.querySelector(".gender-icon.male").style.background = "#ccc";
});
...
form.addEventListener("click", function() {
  ...
  const age = document.querySelector('input[type="range"]').value;
